...
module nios_mm_interconnect_0 (
		...
		output wire [1:0]  GPIO_IN_s1_address,                               //                                 GPIO_IN_s1.address
		input  wire [31:0] GPIO_IN_s1_readdata,                              //                                           .readdata
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> KEY_s1_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> KEY_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // KEY_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> KEY_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> KEY_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> KEY_s1_agent:cp_endofpacket
	wire  [31:0] gpio_in_s1_agent_m0_readdata;                                                       // GPIO_IN_s1_translator:uav_readdata -> GPIO_IN_s1_agent:m0_readdata
	wire         gpio_in_s1_agent_m0_waitrequest;                                                    // GPIO_IN_s1_translator:uav_waitrequest -> GPIO_IN_s1_agent:m0_waitrequest
	wire         gpio_in_s1_agent_m0_debugaccess;                                                    // GPIO_IN_s1_agent:m0_debugaccess -> GPIO_IN_s1_translator:uav_debugaccess
	wire  [16:0] gpio_in_s1_agent_m0_address;                                                        // GPIO_IN_s1_agent:m0_address -> GPIO_IN_s1_translator:uav_address
	wire   [3:0] gpio_in_s1_agent_m0_byteenable;                                                     // GPIO_IN_s1_agent:m0_byteenable -> GPIO_IN_s1_translator:uav_byteenable
	wire         gpio_in_s1_agent_m0_read;                                                           // GPIO_IN_s1_agent:m0_read -> GPIO_IN_s1_translator:uav_read
	wire         gpio_in_s1_agent_m0_readdatavalid;                                                  // GPIO_IN_s1_translator:uav_readdatavalid -> GPIO_IN_s1_agent:m0_readdatavalid
	wire         gpio_in_s1_agent_m0_lock;                                                           // GPIO_IN_s1_agent:m0_lock -> GPIO_IN_s1_translator:uav_lock
	wire  [31:0] gpio_in_s1_agent_m0_writedata;                                                      // GPIO_IN_s1_agent:m0_writedata -> GPIO_IN_s1_translator:uav_writedata
	wire         gpio_in_s1_agent_m0_write;                                                          // GPIO_IN_s1_agent:m0_write -> GPIO_IN_s1_translator:uav_write
	wire   [2:0] gpio_in_s1_agent_m0_burstcount;                                                     // GPIO_IN_s1_agent:m0_burstcount -> GPIO_IN_s1_translator:uav_burstcount
	wire         gpio_in_s1_agent_rf_source_valid;                                                   // GPIO_IN_s1_agent:rf_source_valid -> GPIO_IN_s1_agent_rsp_fifo:in_valid
	wire  [93:0] gpio_in_s1_agent_rf_source_data;                                                    // GPIO_IN_s1_agent:rf_source_data -> GPIO_IN_s1_agent_rsp_fifo:in_data
	wire         gpio_in_s1_agent_rf_source_ready;                                                   // GPIO_IN_s1_agent_rsp_fifo:in_ready -> GPIO_IN_s1_agent:rf_source_ready
	wire         gpio_in_s1_agent_rf_source_startofpacket;                                           // GPIO_IN_s1_agent:rf_source_startofpacket -> GPIO_IN_s1_agent_rsp_fifo:in_startofpacket
	wire         gpio_in_s1_agent_rf_source_endofpacket;                                             // GPIO_IN_s1_agent:rf_source_endofpacket -> GPIO_IN_s1_agent_rsp_fifo:in_endofpacket
	wire         gpio_in_s1_agent_rsp_fifo_out_valid;                                                // GPIO_IN_s1_agent_rsp_fifo:out_valid -> GPIO_IN_s1_agent:rf_sink_valid
	wire  [93:0] gpio_in_s1_agent_rsp_fifo_out_data;                                                 // GPIO_IN_s1_agent_rsp_fifo:out_data -> GPIO_IN_s1_agent:rf_sink_data
	wire         gpio_in_s1_agent_rsp_fifo_out_ready;                                                // GPIO_IN_s1_agent:rf_sink_ready -> GPIO_IN_s1_agent_rsp_fifo:out_ready
	wire         gpio_in_s1_agent_rsp_fifo_out_startofpacket;                                        // GPIO_IN_s1_agent_rsp_fifo:out_startofpacket -> GPIO_IN_s1_agent:rf_sink_startofpacket
	wire         gpio_in_s1_agent_rsp_fifo_out_endofpacket;                                          // GPIO_IN_s1_agent_rsp_fifo:out_endofpacket -> GPIO_IN_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> GPIO_IN_s1_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> GPIO_IN_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // GPIO_IN_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> GPIO_IN_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> GPIO_IN_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> GPIO_IN_s1_agent:cp_endofpacket
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> LEDR_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // LEDR_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> LEDR_s1_agent:cp_channel
	...
	wire  [92:0] key_s1_agent_rp_data;                                                               // KEY_s1_agent:rp_data -> router_005:sink_data
	...
	wire         gpio_in_s1_agent_rp_valid;                                                          // GPIO_IN_s1_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] gpio_in_s1_agent_rp_data;                                                           // GPIO_IN_s1_agent:rp_data -> router_006:sink_data
	wire         gpio_in_s1_agent_rp_ready;                                                          // router_006:sink_ready -> GPIO_IN_s1_agent:rp_ready
	wire         gpio_in_s1_agent_rp_startofpacket;                                                  // GPIO_IN_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         gpio_in_s1_agent_rp_endofpacket;                                                    // GPIO_IN_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [92:0] ledr_s1_agent_rp_data;                                                              // LEDR_s1_agent:rp_data -> router_007:sink_data
	...
	wire         gpio_in_s1_agent_rdata_fifo_src_valid;                                              // GPIO_IN_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] gpio_in_s1_agent_rdata_fifo_src_data;                                               // GPIO_IN_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         gpio_in_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_004:in_0_ready -> GPIO_IN_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> GPIO_IN_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> GPIO_IN_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // GPIO_IN_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> GPIO_IN_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) gpio_in_s1_translator (
		.clk                    (clk_0_clk_clk),                                    //                      clk.clk
		.reset                  (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (gpio_in_s1_agent_m0_address),                      // avalon_universal_slave_0.address
		.uav_burstcount         (gpio_in_s1_agent_m0_burstcount),                   //                         .burstcount
		.uav_read               (gpio_in_s1_agent_m0_read),                         //                         .read
		.uav_write              (gpio_in_s1_agent_m0_write),                        //                         .write
		.uav_waitrequest        (gpio_in_s1_agent_m0_waitrequest),                  //                         .waitrequest
		.uav_readdatavalid      (gpio_in_s1_agent_m0_readdatavalid),                //                         .readdatavalid
		.uav_byteenable         (gpio_in_s1_agent_m0_byteenable),                   //                         .byteenable
		.uav_readdata           (gpio_in_s1_agent_m0_readdata),                     //                         .readdata
		.uav_writedata          (gpio_in_s1_agent_m0_writedata),                    //                         .writedata
		.uav_lock               (gpio_in_s1_agent_m0_lock),                         //                         .lock
		.uav_debugaccess        (gpio_in_s1_agent_m0_debugaccess),                  //                         .debugaccess
		.av_address             (GPIO_IN_s1_address),                               //      avalon_anti_slave_0.address
		.av_readdata            (GPIO_IN_s1_readdata),                              //                         .readdata
		.av_write               (),                                                 //              (terminated)
		.av_read                (),                                                 //              (terminated)
		.av_writedata           (),                                                 //              (terminated)
		.av_begintransfer       (),                                                 //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (gpio_in_s1_agent_m0_address),                      //              m0.address
		.m0_burstcount           (gpio_in_s1_agent_m0_burstcount),                   //                .burstcount
		.m0_byteenable           (gpio_in_s1_agent_m0_byteenable),                   //                .byteenable
		.m0_debugaccess          (gpio_in_s1_agent_m0_debugaccess),                  //                .debugaccess
		.m0_lock                 (gpio_in_s1_agent_m0_lock),                         //                .lock
		.m0_readdata             (gpio_in_s1_agent_m0_readdata),                     //                .readdata
		.m0_readdatavalid        (gpio_in_s1_agent_m0_readdatavalid),                //                .readdatavalid
		.m0_read                 (gpio_in_s1_agent_m0_read),                         //                .read
		.m0_waitrequest          (gpio_in_s1_agent_m0_waitrequest),                  //                .waitrequest
		.m0_writedata            (gpio_in_s1_agent_m0_writedata),                    //                .writedata
		.m0_write                (gpio_in_s1_agent_m0_write),                        //                .write
		.rp_endofpacket          (gpio_in_s1_agent_rp_endofpacket),                  //              rp.endofpacket
		.rp_ready                (gpio_in_s1_agent_rp_ready),                        //                .ready
		.rp_valid                (gpio_in_s1_agent_rp_valid),                        //                .valid
		.rp_data                 (gpio_in_s1_agent_rp_data),                         //                .data
		.rp_startofpacket        (gpio_in_s1_agent_rp_startofpacket),                //                .startofpacket
		...
		.rf_sink_ready           (gpio_in_s1_agent_rsp_fifo_out_ready),              //         rf_sink.ready
		.rf_sink_valid           (gpio_in_s1_agent_rsp_fifo_out_valid),              //                .valid
		.rf_sink_startofpacket   (gpio_in_s1_agent_rsp_fifo_out_startofpacket),      //                .startofpacket
		.rf_sink_endofpacket     (gpio_in_s1_agent_rsp_fifo_out_endofpacket),        //                .endofpacket
		.rf_sink_data            (gpio_in_s1_agent_rsp_fifo_out_data),               //                .data
		.rf_source_ready         (gpio_in_s1_agent_rf_source_ready),                 //       rf_source.ready
		.rf_source_valid         (gpio_in_s1_agent_rf_source_valid),                 //                .valid
		.rf_source_startofpacket (gpio_in_s1_agent_rf_source_startofpacket),         //                .startofpacket
		.rf_source_endofpacket   (gpio_in_s1_agent_rf_source_endofpacket),           //                .endofpacket
		.rf_source_data          (gpio_in_s1_agent_rf_source_data),                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                //                .error
		.rdata_fifo_src_ready    (gpio_in_s1_agent_rdata_fifo_src_ready),            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (gpio_in_s1_agent_rdata_fifo_src_valid),            //                .valid
		.rdata_fifo_src_data     (gpio_in_s1_agent_rdata_fifo_src_data),             //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) gpio_in_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                    //       clk.clk
		.reset             (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (gpio_in_s1_agent_rf_source_data),                  //        in.data
		.in_valid          (gpio_in_s1_agent_rf_source_valid),                 //          .valid
		.in_ready          (gpio_in_s1_agent_rf_source_ready),                 //          .ready
		.in_startofpacket  (gpio_in_s1_agent_rf_source_startofpacket),         //          .startofpacket
		.in_endofpacket    (gpio_in_s1_agent_rf_source_endofpacket),           //          .endofpacket
		.out_data          (gpio_in_s1_agent_rsp_fifo_out_data),               //       out.data
		.out_valid         (gpio_in_s1_agent_rsp_fifo_out_valid),              //          .valid
		.out_ready         (gpio_in_s1_agent_rsp_fifo_out_ready),              //          .ready
		.out_startofpacket (gpio_in_s1_agent_rsp_fifo_out_startofpacket),      //          .startofpacket
		.out_endofpacket   (gpio_in_s1_agent_rsp_fifo_out_endofpacket),        //          .endofpacket
		.csr_address       (2'b00),                                            // (terminated)
		.csr_read          (1'b0),                                             // (terminated)
		.csr_write         (1'b0),                                             // (terminated)
		.csr_readdata      (),                                                 // (terminated)
	...
	nios_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (gpio_in_s1_agent_rp_ready),                        //      sink.ready
		.sink_valid         (gpio_in_s1_agent_rp_valid),                        //          .valid
		.sink_data          (gpio_in_s1_agent_rp_data),                         //          .data
		.sink_startofpacket (gpio_in_s1_agent_rp_startofpacket),                //          .startofpacket
		.sink_endofpacket   (gpio_in_s1_agent_rp_endofpacket),                  //          .endofpacket
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (gpio_in_s1_agent_rdata_fifo_src_data),             //     in_0.data
		.in_0_valid     (gpio_in_s1_agent_rdata_fifo_src_valid),            //         .valid
		.in_0_ready     (gpio_in_s1_agent_rdata_fifo_src_ready),            //         .ready
